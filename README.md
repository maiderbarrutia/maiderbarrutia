...
- **TypeScript**  
  Tipado sólido orientado a código mantenible, claro y robusto.

- **Maquetación profesional**  
  HTML5 + CSS3 (Grid, Flexbox), SASS modular y enfoque Mobile First.

- **Diseño responsive y accesible**  
  Interfaces adaptadas a cualquier dispositivo, aplicando buenas prácticas de accesibilidad y SEO.

- **Integración diseño–desarrollo**  
  Trabajo fluido con Figma y herramientas de diseño, trasladando diseños a código realista y funcional.

- **Optimización y rendimiento**  
  Buenas prácticas en estructura de componentes, carga y mantenimiento a largo plazo.

- **Testing frontend**  
  Tests con Jest, Vitest y React Testing Library para componentes fiables.
